...
- Comfortable reading Python code (regex, error handling, JSON)
...
TO ACTIVATE:
1. Uncomment the hooks section in settings.json
2. Update CLAUDE.md "Current Setup" section to mark as ACTIVE
3. Test: echo '{"tool_name":"Bash","tool_input":{"command":"grep foo"}}' | uv run .claude/hooks/tool_validator.py

WHY THIS HOOK:
Enforces modern tooling (rg, bat, fd, sd) to build muscle memory for 2025 best practices.
Also serves as a real-world Python example you can study and modify.
"""
